...
|--------|----------|------------|-------------|---------|
| [Claude Code](claude-code.md) | VS Code Extension | 2 min | `examples/mcp-configs/claude-code.json` | ✅ Ready |
| [GitHub Copilot CLI](copilot-cli.md) | GitHub CLI | 3 min | `examples/mcp-configs/copilot-cli.json` | ✅ Ready |
| [OpenCode](opencode.md) | Open MCP Client | 2 min | `examples/mcp-configs/opencode.json` | ✅ Ready |
